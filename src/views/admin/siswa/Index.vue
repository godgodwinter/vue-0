...
const getDataId = async () => {
  try {
    const response = await Api.get(`siswa/${dataId}`);
...
const doStoreData = async (d) => {
  ...
  try {
    if (dataId) {
      const response = await Api.put(`siswa/${dataId}`, {
        name: d.name,
        nis: d.nis,
      });
                ...
                <div class="grid grid-cols-1 gap-6">
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <Field
                      ...
                      required
                    />
                    <div class="text-xs text-red-600 mt-1">{{ errors.nis }}</div>
                  </div>
                </div>
                <div class="grid grid-cols-1 gap-6">
                  <div class="col-span-6 sm:col-span-3">
